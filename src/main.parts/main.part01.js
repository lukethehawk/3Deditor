...
const staticTranslations = {
  en: {
    ...
    'Ripristina (Ctrl+Y / Ctrl+Shift+Z)': 'Redo (Ctrl+Y / Ctrl+Shift+Z)',
    'Modifica': 'Change',
    ...
    'Canc elimina selezione o anteprima. Ctrl+Z annulla, Ctrl+Y o Ctrl+Shift+Z ripristina.': 'Delete removes the selection or preview. Ctrl+Z undoes, Ctrl+Y or Ctrl+Shift+Z redoes.',
    ...
    'Orienta faccia in basso': 'Orient face downward',
    ...
    'Trasforma: clicca una faccia come riferimento oppure doppio click sul corpo.': 'Transform: click a face as reference, or double-click the body.',
    'Trasforma: clicca una faccia come riferimento, oppure doppio click sul corpo.': 'Transform: click a face as reference, or double-click the body.',
    ...
    'Seleziona una faccia o un corpo prima di trasformarlo.': 'Select a face or body before transforming it.',
    ...
    'Trasforma: clicca una faccia per impostare il riferimento.': 'Transform: click a face to set the reference.',
    'Non riesco a selezionare il corpo collegato alla faccia.': 'I cannot select the body connected to that face.',
    'Faccia di riferimento selezionata. Sposta e scala agiscono sul corpo collegato.': 'Reference face selected. Move and scale affect the connected body.',
    ...
    'faccia ruotata in basso': 'face oriented downward',
    'Faccia selezionata appoggiata al piano Z=0.': 'Selected face placed on the Z=0 bed.',
    'Faccia selezionata ruotata verso il basso.': 'Selected face oriented downward while keeping the body height.',
